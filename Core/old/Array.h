...
// Default structure is RegularArrayContainer with default allocator. Default integral type is int.
template <class V, class I = int, class S = RegularArrayContainer<V> >
class Array
{
private:
